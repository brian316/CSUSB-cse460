  ...
  19:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  if(argc < 2 )
  1f:	7f 74                	jg     95 <main+0x95>
    n = 1;       //default value
  21:	31 db                	xor    %ebx,%ebx
  23:	eb 26                	jmp    4b <main+0x4b>
  ...
  28:	0f 84 86 00 00 00    	je     b4 <main+0xb4>
  ...
  35:	83 c3 01             	add    $0x1,%ebx
      printf(1, "Parent %d creating child  %d\n", getpid(), id );
  38:	68 ec 07 00 00       	push   $0x7ec
  3d:	6a 01                	push   $0x1
  3f:	e8 3c 04 00 00       	call   480 <printf>
  44:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  47:	39 df                	cmp    %ebx,%edi
  49:	7e 2d                	jle    78 <main+0x78>
    id = fork ();
  4b:	e8 da 02 00 00       	call   32a <fork>
    if ( id < 0 ) {
  50:	85 c0                	test   %eax,%eax
    id = fork ();
  52:	89 c6                	mov    %eax,%esi
    if ( id < 0 ) {
  54:	79 d2                	jns    28 <main+0x28>
      printf(1, "%d failed in fork!\n", getpid() );
  56:	e8 57 03 00 00       	call   3b2 <getpid>
  ...
  for ( k = 0; k < n; k++ ) {
  71:	39 df                	cmp    %ebx,%edi
  73:	7f d6                	jg     4b <main+0x4b>
  ...
  78:	d9 ee                	fldz   
  7a:	dd 05 20 08 00 00    	fldl   0x820
  80:	dc c1                	fadd   %st,%st(1)
  82:	d9 05 28 08 00 00    	flds   0x828
  88:	df ea                	fucomip %st(2),%st
  8a:	77 f4                	ja     80 <main+0x80>
  8c:	dd d8                	fstp   %st(0)
  8e:	dd d8                	fstp   %st(0)
       x =  x + 3.14 * 89.64;   // useless calculations to consume CPU time
  exit();
  90:	e8 9d 02 00 00       	call   332 <exit>
    n = atoi ( argv[1] ); //from command line
  95:	83 ec 0c             	sub    $0xc,%esp
  98:	ff 70 04             	pushl  0x4(%eax)
  9b:	e8 20 02 00 00       	call   2c0 <atoi>
  if ( n < 0 || n > 20 )
  a0:	83 c4 10             	add    $0x10,%esp
  a3:	83 f8 14             	cmp    $0x14,%eax
    n = atoi ( argv[1] ); //from command line
  a6:	89 c7                	mov    %eax,%edi
  if ( n < 0 || n > 20 )
  a8:	76 22                	jbe    cc <main+0xcc>
    n = 2;
  aa:	bf 02 00 00 00       	mov    $0x2,%edi
  af:	e9 6d ff ff ff       	jmp    21 <main+0x21>
      printf(1, "Child %d created\n",getpid() );
  b4:	e8 f9 02 00 00       	call   3b2 <getpid>
  b9:	52                   	push   %edx
  ba:	50                   	push   %eax
  bb:	68 0a 08 00 00       	push   $0x80a
  c0:	6a 01                	push   $0x1
  c2:	e8 b9 03 00 00       	call   480 <printf>
      break;
  c7:	83 c4 10             	add    $0x10,%esp
  ca:	eb ac                	jmp    78 <main+0x78>
  for ( k = 0; k < n; k++ ) {
  cc:	85 c0                	test   %eax,%eax
  ce:	0f 85 4d ff ff ff    	jne    21 <main+0x21>
  d4:	eb a2                	jmp    78 <main+0x78>
  d6:	66 90                	xchg   %ax,%ax
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 651:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 e4 0a 00 00       	mov    %eax,0xae4
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 e4 0a 00 00       	mov    %eax,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 e4 0a 00 00    	cmp    %eax,0xae4
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 e4 0a 00 00 e8 	movl   $0xae8,0xae4
 7a7:	0a 00 00 
 7aa:	c7 05 e8 0a 00 00 e8 	movl   $0xae8,0xae8
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 e8 0a 00 00       	mov    $0xae8,%eax
 7b9:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 7c0:	00 00 00 
