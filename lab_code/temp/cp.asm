...
main(int argc, char *argv[])
{
  ...
  19:	c7 45 e4 02 00 00 00 	movl   $0x2,-0x1c(%ebp)
	if (argc <= 2) {
  20:	83 f8 02             	cmp    $0x2,%eax
{
  23:	89 45 dc             	mov    %eax,-0x24(%ebp)
  26:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  29:	8d 79 08             	lea    0x8(%ecx),%edi
	if (argc <= 2) {
  2c:	0f 8e 9e 00 00 00    	jle    d0 <main+0xd0>
  32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if ((fd0 = open(argv[1], O_RDONLY)) < 0) {
  38:	8b 45 e0             	mov    -0x20(%ebp),%eax
  3b:	83 ec 08             	sub    $0x8,%esp
  3e:	6a 00                	push   $0x0
  40:	ff 70 04             	pushl  0x4(%eax)
  43:	e8 5a 03 00 00       	call   3a2 <open>
  48:	83 c4 10             	add    $0x10,%esp
  4b:	85 c0                	test   %eax,%eax
  4d:	89 c3                	mov    %eax,%ebx
  4f:	0f 88 8e 00 00 00    	js     e3 <main+0xe3>
  ...
  5d:	ff 37                	pushl  (%edi)
  5f:	e8 3e 03 00 00       	call   3a2 <open>
  64:	83 c4 10             	add    $0x10,%esp
  67:	85 c0                	test   %eax,%eax
  69:	89 c6                	mov    %eax,%esi
  6b:	79 1d                	jns    8a <main+0x8a>
  6d:	e9 89 00 00 00       	jmp    fb <main+0xfb>
  ...
  81:	56                   	push   %esi
  82:	e8 fb 02 00 00       	call   382 <write>
  ...
  97:	53                   	push   %ebx
  98:	e8 dd 02 00 00       	call   37a <read>
  ...
  a7:	83 c7 04             	add    $0x4,%edi
  aa:	53                   	push   %ebx
  ab:	e8 da 02 00 00       	call   38a <close>
		close(fd1);
  b0:	89 34 24             	mov    %esi,(%esp)
  b3:	e8 d2 02 00 00       	call   38a <close>
	for (int i = 2; i <= argc; i++) {
  b8:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
  bc:	83 c4 10             	add    $0x10,%esp
  bf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  c2:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  c5:	0f 8d 6d ff ff ff    	jge    38 <main+0x38>
	}
	
	exit();
  cb:	e8 92 02 00 00       	call   362 <exit>
		printf(1, "need 2 arguments!\n");
  d0:	51                   	push   %ecx
  d1:	51                   	push   %ecx
  d2:	68 08 08 00 00       	push   $0x808
  d7:	6a 01                	push   $0x1
  d9:	e8 d2 03 00 00       	call   4b0 <printf>
		exit();
  de:	e8 7f 02 00 00       	call   362 <exit>
			printf(1, "CP: cannot open %s\n", argv[1]);
  e3:	8b 45 e0             	mov    -0x20(%ebp),%eax
  e6:	52                   	push   %edx
  e7:	ff 70 04             	pushl  0x4(%eax)
  ea:	68 1b 08 00 00       	push   $0x81b
  ef:	6a 01                	push   $0x1
  ...
  fb:	50                   	push   %eax
  fc:	ff 37                	pushl  (%edi)
  fe:	68 1b 08 00 00       	push   $0x81b
 103:	6a 01                	push   $0x1
 105:	e8 a6 03 00 00       	call   4b0 <printf>
			exit();
 10a:	e8 53 02 00 00       	call   362 <exit>
 10f:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 2f 08 00 00       	mov    $0x82f,%ebx
        while(*s != 0){
